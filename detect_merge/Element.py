...
class Element:
    ...
    def visualize_element(self, img, color=(0, 255, 0), line=1, show=False):
        ...
        cv2.putText(img, str(self.id), (loc[0], loc[1] + 12), cv2.FONT_HERSHEY_DUPLEX, 0.5, (0, 0, 0), 3)
        cv2.putText(img, str(self.id), (loc[0], loc[1] + 12), cv2.FONT_HERSHEY_DUPLEX, 0.5, color, 2)
        # for child in self.children:
